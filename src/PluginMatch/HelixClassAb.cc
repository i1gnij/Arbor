...
void HelixClassAb::Initialize_VP(float * pos, float * mom, float q, float B) {
...
void HelixClassAb::Initialize_Canonical(float phi0, float d0, float z0, 
...
void HelixClassAb::Initialize_BZ(float xCentre, float yCentre, float radius, 
...
const float * HelixClassAb::getMomentum() {
    return _momentum;
}
const float * HelixClassAb::getReferencePoint() {
    return _referencePoint;
}
float HelixClassAb::getPhi0() {
  if (_phi0<0.0)
    _phi0 += 2*M_PI;
  return _phi0;
}
float HelixClassAb::getD0() {
    return _d0;
}
float HelixClassAb::getZ0() {
    return _z0;
}
float HelixClassAb::getOmega() {
    return _omega;
}
float HelixClassAb::getTanLambda() {
    return _tanLambda;
}
float HelixClassAb::getPXY() {
    return _pxy;
}
float HelixClassAb::getXC() {
  return _xCentre;
}

float HelixClassAb::getYC() {
  return _yCentre;
}

float HelixClassAb::getRadius() {
  return _radius;
}

float HelixClassAb::getBz() {
  return _bZ;
}

float HelixClassAb::getPhiZ() {
  return _phiZ;
}

float HelixClassAb::getCharge() {
    return _charge;
}

float HelixClassAb::getPointInXY(float x0, float y0, float ax, float ay, 
...
float HelixClassAb::getPointOnCircle(float Radius, float * ref, float * point) {
...
float HelixClassAb::getPointInZ(float zLine, float * ref, float * point) {
...
int HelixClassAb::getNCircle(float * xPoint) {
...
float HelixClassAb::getDistanceToPoint(float * xPoint, float * Distance) {

  //std::cout<<"HHHHHHHHHHHHHHHHHHHHHHHH: Overload 0"<<std::endl;
...
float HelixClassAb::getDistanceToPoint(const std::vector<float>& xPoint, float distCut) {
  //calculate distance to XYprojected centre of Helix, comparing this with distance to radius around centre gives DistXY
...
float HelixClassAb::getDistanceToPoint(const float* xPoint, float distCut) {
...
void HelixClassAb::setHelixEdges(float * xStart, float * xEnd) {
  for (int i=0; i<3; ++i) {
    _xStart[i] = xStart[i];
    _xEnd[i] = xEnd[i];
  }
...
float HelixClassAb::getDistanceToHelix(HelixClassAb * helix, float * pos, float * mom) {
...
void HelixClassAb::getExtrapolatedMomentum(float * pos, float * momentum) {
